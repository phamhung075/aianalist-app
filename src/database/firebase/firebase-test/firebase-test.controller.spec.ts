...
describe('FirebaseTestController', () => {
      ...
      providers: [
        {
          ...
          useValue: {
            ...
            setDocument: jest.fn().mockResolvedValue({ success: true }),
  ...
  it('should get a document', async () => {
    ...
    expect(repositoryService.getDocument).toHaveBeenCalledWith('users', '123');
  });
  ...
  it('should set a document', async () => {
    ...
    expect(repositoryService.setDocument).toHaveBeenCalledWith('users', '123', {
      name: 'Test',
    });
  });
